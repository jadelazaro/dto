        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-4">
                ...
                <form action="manage_announcements.php" method="POST">
                    ...
                    <button type="submit" class="bg-green-600 text-white rounded px-4 py-2">Add Announcement</button>
                </form>
                <div class="mt-4">
            ...
            <div class="bg-white rounded-lg shadow-md p-4">
                ...
                <form action="manage_news.php" method="POST">
                    ...
                    <button type="submit" class="bg-green-600 text-white rounded px-4 py-2">Add News</button>
                </form>
                <div class="mt-4">
